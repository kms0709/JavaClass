...
public class Ex5_Wrapper_클래스_활용 {
	...
	public static void main(String[] args) {
		...
		// Integer 사용
		System.out.println(Integer.parseInt("28")); //28
		// 문자열 "28"을 10진수로 변환
		System.out.println(Integer.toString(28)); //"28"
		// 정수 28을 2진수 문자열로 변환
		...
		// Double 사용
		Double d = Double.valueOf(3.14); //Double d =3.14;
